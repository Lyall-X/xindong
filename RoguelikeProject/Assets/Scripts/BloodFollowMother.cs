...
public class BloodFollowMother : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            addMotherBlood.transform.position = player3DPosition + new Vector3(60, 40, 20);
        }
    }
    public void OnValueChange()
    {
        ...
        {
            image.transform.localScale = new Vector3((float)GameManager.Instance.mother_food / 60, 0.1f, 1);
        }
        else
        {
